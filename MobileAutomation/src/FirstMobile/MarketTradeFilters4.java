...
public class MarketTradeFilters4 extends CommonClassForMobile{
	
	@Test
	public void FilterCrieteria4() throws InterruptedException, IOException 	{
...
driver.findElement(By.id("com.mfcwl.mfc_dealer:id/tools_filter")).click();
        ...
        System.out.println("Screenshot has been taken and stored in E:\\software\\mobilescreenshot folder location after applying filter");
        
        driver.findElement(By.id("com.mfcwl.mfc_dealer:id/tools_filter")).click();
		
		Thread.sleep(2000);
		
		System.out.println("clicked on filter icon again");
		
		driver.findElement(By.id("com.mfcwl.mfc_dealer:id/stock_fil_clear")).click();
		
		System.out.println("cleared the filter");
		
		DateFormat dateFormat1 = new SimpleDateFormat("dd-mm-yyyy h-m-s");
        Date date1 = new Date();
        File scrFile1 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String S1 = "snap";
        FileUtils.copyFile(scrFile1, new File("E:\\software\\mobilescreenshot\\mobilesnap.png"+S1+"-"+dateFormat1.format(date1)+".png"));
        
        System.out.println("Screenshot has been taken and stored in E:\\software\\mobilescreenshot folder location after clearing filter");
